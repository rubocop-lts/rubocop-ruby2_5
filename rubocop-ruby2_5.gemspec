...
Gem::Specification.new do |spec|
  ...
  spec.version = Module.new.tap { |mod| Kernel.load("#{__dir__}/lib/rubocop/ruby2_5/version.rb", mod) }::Rubocop::Ruby25::Version::VERSION
  ...
  spec.metadata["homepage_uri"] = "https://rubocop-ruby2-5.galtzo.com"
  ...
  # The 'git' gem is optional; rubocop-ruby2_5 falls back to shelling out to `git` if it is not present.
